        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-black tracking-tight text-white">
              Кандидаты с strongest fit для комиссии
            </h2>
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-text-secondary">
              Здесь собраны профили с лучшим балансом по cognitive, growth, motivation и
              authenticity. Все рекомендации остаются decision-support, а не автоотбором.
            </p>
          </div>
          <GreenButton variant="outline" icon={<ArrowUpRight className="h-4 w-4" />}>
            Экспорт shortlist
          </GreenButton>
        </div>
      </section>
