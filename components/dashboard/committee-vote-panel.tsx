  ...
  return (
    <div className="rounded-[24px] border border-white/6 bg-bg-surface p-5">
      ...
      <div className="grid grid-cols-3 gap-2">
        {(["approve", "hold", "reject"] as CommitteeVoteDecision[]).map((item) => (
          <button
            ...
            className={`rounded-2xl px-4 py-3 text-sm font-semibold transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/35 active:scale-[0.98] ${
              decision === item
      ...
      <textarea
        ...
        className="mt-4 w-full rounded-2xl border border-white/8 bg-bg-elevated px-4 py-3 text-sm text-white outline-none placeholder:text-text-muted focus:border-brand-green/25 focus-visible:ring-2 focus-visible:ring-brand-green/30"
      />
      ...
      <button
        ...
        onClick={submitVote}
        className="mt-4 inline-flex w-full items-center justify-center rounded-2xl bg-brand-green px-5 py-3 text-sm font-bold text-black transition-all duration-150 hover:bg-brand-dim focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/35 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
      >
